...
constructor(private val objTypes: ObjTypeList, private val ammunition: RangedAmmoManager) :
    ...
    override fun SpecialAttackRepository.register(manager: SpecialAttackManager) {
        registerRanged(
            ...
            DragonCrossbow(manager, ammunition, objTypes),
        )
        registerRanged(
...
private class DragonCrossbow(
    ...
    private fun ProtectedAccess.blast(target: PathingEntity, attack: CombatAttack.Ranged): Boolean {
        ...
        val projectile =
            manager.spawnProjectile(this, target, special_spots.dragon_crossbow, projanims.bolt)
        val damage =
