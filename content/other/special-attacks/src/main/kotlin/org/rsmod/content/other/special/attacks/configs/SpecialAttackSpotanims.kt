...
object SpecialAttackSpotanims : SpotanimReferences() {
    ...
    val brain_anchor = find("brain_anchor_special_attack_spot")
    val magic_shortbow = find("sp_attack_snapshot_spotanim")
    val dragon_crossbow = find("dragon_crossbowbolt_travel")
    val armadyl_crossbow = find("acb_crossbowbolt_travel")
    ...
    val dragon_halberd = find("dragon_halberd_special_south_red")
    val abyssal_whip = find("sp_attack_abyssal_whip")
    val elder_maul = find("spotanim_elder_maul_special")
    val ags = find("godwars_godsword_armadyl_spot")
    val bgs = find("godwars_godsword_bandos_spot")
    ...
    val voidwaker_impact = find("fx_voidwaker_impact")
    val ancient_godsword = find("xbows_blood_sacrifice_spot_anim")
